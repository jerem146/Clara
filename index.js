...
import { shirokoJadiBot } from './plugins/jadibot-serbot.js';
...
if (connection == 'open') {
console.log(chalk.bold.green('\n❀ ShirokoBot- Conectada con éxito ❀'))
}
...
shirokoJadiBot({pathShirokoiJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
